...
def solve_simultaneous_optimization(model, model_info, time_limit=200, gap_tolerance=0.03):
    """
...
def optimize_jury_assignment(data_dict, tier_weights=None, time_limit=200, gap_tolerance=0.03):
    """
